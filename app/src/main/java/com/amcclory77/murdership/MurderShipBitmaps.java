...
public class MurderShipBitmaps {
	...
	private void LoadRooms() {
		Bitmap rooms = BitmapFactory.decodeResource(mRes, R.drawable.rooms, mOptions);
		rooms.setDensity(Bitmap.DENSITY_NONE);
	...
	private void LoadCharacters() {
		Bitmap characters = BitmapFactory.decodeResource(mRes, R.drawable.characters, mOptions);
		characters.setDensity(Bitmap.DENSITY_NONE);
	...
	private void LoadObjects() {
		Bitmap objects = BitmapFactory.decodeResource(mRes, R.drawable.objects, mOptions);
		objects.setDensity(Bitmap.DENSITY_NONE);
	...
	private void LoadItems() {
		Bitmap items = BitmapFactory.decodeResource(mRes, R.drawable.items, mOptions);
		items.setDensity(Bitmap.DENSITY_NONE);
	...
	private void LoadActions() {
		...
		Bitmap actions = BitmapFactory.decodeResource(mRes, R.drawable.actions, mOptions);
		actions.setDensity(Bitmap.DENSITY_NONE);
	...
	private void LoadTarget() {
		mTargetBitmap = BitmapFactory.decodeResource(mRes, R.drawable.target, mOptions);
		mTargetBitmap.setDensity(Bitmap.DENSITY_NONE);
